      ...
      <div className="home-page__body">
        ...
        <main className="product-section">
          <div className="product-toolbar">
            ...
            <select
              className="product-toolbar__select"
              value={params.limit ?? DEFAULT_PAGE_SIZE}
